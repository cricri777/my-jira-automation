...
class Jira:
    ...
    def __init__(
        self, jira_base_url: str, jira_username: str, jira_api_token: str, jira_project_id: str
    ):
        logger.debug(
            f"Create jira object with jira_user={jira_username}"
    ...
    def create_ticket(self, summary: str, description: str):
        ...
        jira_json_response = post_request(
            jira_url, self._jira_user_name, self._jira_api_token, body
        )
